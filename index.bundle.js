...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://portfolio_package/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _components_aboutRelated_about_related_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/aboutRelated/about-related.js */ \"./src/components/aboutRelated/about-related.js\");\n/* harmony import */ var _components_projectRelated_project_related_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/projectRelated/project-related.js */ \"./src/components/projectRelated/project-related.js\");\n/* harmony import */ var _components_contactRelated_contact_related_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/contactRelated/contact-related.js */ \"./src/components/contactRelated/contact-related.js\");\n/* harmony import */ var _components_animations_heading_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/animations/heading.js */ \"./src/components/animations/heading.js\");\n/* harmony import */ var _components_animations_project_title_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/animations/project-title.js */ \"./src/components/animations/project-title.js\");\n/* harmony import */ var _components_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/carousel/carousel.js */ \"./src/components/carousel/carousel.js\");\n\n\n\n\n\n\n\n\n\nwindow.addEventListener(\"DOMContentLoaded\", () => {\n  const aboutSection = document.querySelector(\".about-section\");\n  const projectsSection = document.querySelector(\".projects-section\");\n  const contactSection = document.querySelector(\".contact-section\");\n  const imgSliderContainer = projectsSection.querySelector(\".img-slider-container\");\n  const projectSummaryContainer = projectsSection.querySelector(\".project-summary-container\");\n  const projectLearntContainer = projectsSection.querySelector(\".project-learnt-container\");\n  const projectDateContainer = projectsSection.querySelector(\".project-date-container\");\n  const projectPreviewBtn = projectsSection.querySelector(\".project-btns > .preview-btn\");\n  const projectCodeBtn = projectsSection.querySelector(\".project-btns > .code-btn\");\n\n  const carousel = (0,_components_carousel_carousel_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(imgSliderContainer);\n\n  carousel.initialize();\n\n  const aboutRelated = (0,_components_aboutRelated_about_related_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(aboutSection);\n  aboutRelated.handleMoreBtnClick();\n\n  const projectRelated = (0,_components_projectRelated_project_related_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])([\n    projectSummaryContainer,\n    projectLearntContainer,\n    projectDateContainer,\n    projectPreviewBtn,\n    projectCodeBtn\n  ]);\n\n  const contactRelated = (0,_components_contactRelated_contact_related_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(contactSection);\n  contactRelated.handleContactClick();\n\n  const [aboutH2Container, projectsH2Container, contactH2Container] = document.querySelectorAll(\".animated-h2-container\");\n  (0,_components_animations_heading_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(aboutH2Container, false).add();\n  (0,_components_animations_heading_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(contactH2Container, false).add();\n  const projectsHeadingAnimation = (0,_components_animations_heading_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(projectsH2Container, true);\n  projectsHeadingAnimation.add();\n\n  const projectTitleContainer = projectsSection.querySelector(\".project-title-container\");\n  const projectTitleAnimation = (0,_components_animations_project_title_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(projectTitleContainer);\n\n  let displayedProjectName = carousel.getDisplayedProjectName();\n  projectTitleAnimation.initialize(\n    projectsHeadingAnimation.getResolvingAnimation(),\n    displayedProjectName,\n  )\n    .then(() => {\n      carousel.handleCarouselClick();\n      carousel.handleCarouselHover();\n\n      let slidingSide;\n      let pastDisplayedProjectName = null;\n\n      const slide = () => {\n        slidingSide = carousel.getSlidingSide();\n\n        carousel.slide((slidingSide === \"left\"));\n\n        displayedProjectName = carousel.getDisplayedProjectName();\n\n        projectRelated.update(displayedProjectName);\n        projectTitleAnimation.update(pastDisplayedProjectName, displayedProjectName, (slidingSide === \"left\"));\n\n        pastDisplayedProjectName = displayedProjectName;\n      };\n\n\n      let intervalId = setInterval(slide, 7000);\n\n      imgSliderContainer.addEventListener(\"click\", () => {\n        clearInterval(intervalId);\n        if (carousel.getHasClickedSide()) slide();\n        intervalId = setInterval(slide, 7000);\n      });\n    });\n});\n\n\n//# sourceURL=webpack://portfolio_package/./src/index.js?");
